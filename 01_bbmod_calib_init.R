...
## Define models
#! currently don't use individual marginal models
...
saveRDS(mod_bb_s, file = file.path(wdir,"mod_bb_s.rds"))
}

# joint models
mod_bb_jnt1 <- stan_model(model_code = mod_bb_jnt_code1)
saveRDS(mod_bb_jnt1, file = file.path(wdir,"mod_bb_jnt1.rds"))

mod_bb_jnt2 <- stan_model(model_code = mod_bb_jnt_code2)
saveRDS(mod_bb_jnt2, file = file.path(wdir,"mod_bb_jnt2.rds"))

mod_bb_jnt3 <- stan_model(model_code = mod_bb_jnt_code3)
saveRDS(mod_bb_jnt3, file = file.path(wdir,"mod_bb_jnt3.rds"))
